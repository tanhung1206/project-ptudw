...
INSERT INTO Users (email, username, password, firstName, lastName, avatar, isAdmin, createdAt, isBan)
VALUES
    ('john.doe@example.com', 'johndoe', '$2a$10$7a8b9c8d7e6f5g4h3i2j1k', 'John', 'Doe', '/img/avatars/johndoe.jpg', FALSE, CURRENT_DATE, FALSE),
    ('jane.smith@example.com', 'janesmith', '$2a$10$1a2b3c4d5e6f7g8h9i0j1k', 'Jane', 'Smith', '/img/avatars/janesmith.jpg', FALSE, CURRENT_DATE, FALSE),
    ('alice.wonderland@example.com', 'alicewonderland', '$2a$10$5a6b7c8d9e0f1g2h3i4j5k', 'Alice', 'Wonderland', '/img/avatars/alice.jpg', FALSE, CURRENT_DATE, FALSE),
    ('bob.builder@example.com', 'bobbuilder', '$2a$10$1a2b3c4d5e6f7g8h9i0j1k', 'Bob', 'Builder', '/img/default-avatar.png', FALSE, CURRENT_DATE, FALSE),
    ('charlie.brown@example.com', 'charliebrown', '$2a$10$1a2b3c4d5e6f7g8h9i0j1k', 'Charlie', 'Brown', '/img/default-avatar.png', FALSE, CURRENT_DATE, FALSE),
    ('david.jones@example.com', 'davidjones', '$2a$10$1a2b3c4d5e6f7g8h9i0j1k', 'David', 'Jones', '/img/default-avatar.png', FALSE, CURRENT_DATE, FALSE),
    ('emily.clark@example.com', 'emilyclark', '$2a$10$1a2b3c4d5e6f7g8h9i0j1k', 'Emily', 'Clark', '/img/default-avatar.png', FALSE, CURRENT_DATE, FALSE),
    ('frank.wright@example.com', 'frankwright', '$2a$10$1a2b3c4d5e6f7g8h9i0j1k', 'Frank', 'Wright', '/img/default-avatar.png', FALSE, CURRENT_DATE, FALSE),
    ('george.king@example.com', 'georgeking', '$2a$10$1a2b3c4d5e6f7g8h9i0j1k', 'George', 'King', '/img/default-avatar.png', FALSE, CURRENT_DATE, FALSE),
    ('hannah.martin@example.com', 'hannahmartin', '$2a$10$1a2b3c4d5e6f7g8h9i0j1k', 'Hannah', 'Martin', '/img/default-avatar.png', FALSE, CURRENT_DATE, FALSE),
    ('ian.scott@example.com', 'ianscott', '$2a$10$1a2b3c4d5e6f7g8h9i0j1k', 'Ian', 'Scott', '/img/default-avatarp', FALSE, CURRENT_DATE, FALSE),
    ('julia.roberts@example.com', 'juliaroberts', '$2a$10$1a2b3c4d5e6f7g8h9i0j1k', 'Julia', 'Roberts', '/img/default-avatar.png', FALSE, CURRENT_DATE, FALSE),
    ('kevin.baker@example.com', 'kevinbaker', '$2a$10$1a2b3c4d5e6f7g8h9i0j1k', 'Kevin', 'Baker', '/img/default-avatar.png', FALSE, CURRENT_DATE, FALSE),
...
VALUES
    ('Great product, highly recommend!', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 1, 4),
    ('Not bad, but could be better', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 1, 5),
    ('Decent quality for the price', 4, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 1, 6),
    ('Very comfortable and stylish', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 1, 7),
    ('Good value for money', 4, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 1, 8),
    ('Excellent product, will buy again', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 2, 4),
    ('Not worth the price', 2, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 2, 5),
    ('Average quality', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 2, 6),
    ('Very satisfied with this purchase', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 2, 7),
    ('Would not recommend', 1, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 2, 8),
    ('Amazing product, exceeded expectations', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 3, 4),
    ('Good quality, but a bit expensive', 4, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 3, 5),
    ('Satisfied with the purchase', 4, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 3, 6),
    ('Not as described', 2, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 3, 7),
    ('Excellent quality, highly recommend', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 3, 8),
    ('Very happy with this product', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 4, 4),
    ('Could be better', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 4, 5),
    ('Good product, but overpriced', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 4, 6),
    ('Excellent value for money', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 4, 7),
    ('Not satisfied with the quality', 2, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 4, 8),
    ('Great product, will buy again', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 5, 4),
    ('Decent quality, but not the best', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 5, 5),
    ('Very comfortable', 4, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 5, 6),
    ('Good product, but could be cheaper', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 5, 7),
    ('Excellent quality, very satisfied', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 5, 8),
    ('Very happy with this purchase', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 6, 4),
    ('Not worth the money', 2, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 6, 5),
    ('Good quality, but too expensive', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 6, 6),
    ('Satisfied with the product', 4, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 6, 7),
    ('Excellent product, highly recommend', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 6, 8),
    ('Great value for money', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 7, 4),
    ('Not as good as expected', 2, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 7, 5),
    ('Decent quality, but overpriced', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 7, 6),
    ('Very satisfied with this purchase', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 7, 7),
    ('Good product, but could be better', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 7, 8),
    ('Excellent quality, will buy again', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 8, 4),
    ('Not worth the price', 2, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 8, 5),
    ('Average quality', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 8, 6),
    ('Very satisfied with this product', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 8, 7),
    ('Would not recommend', 1, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 8, 8),
    ('Amazing product, exceeded expectations', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 9, 4),
    ('Good quality, but a bit expensive', 4, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 9, 5),
    ('Satisfied with the purchase', 4, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 9, 6),
    ('Not as described', 2, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 9, 7),
    ('Excellent quality, highly recommend', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 9, 8),
    ('Very happy with this product', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 10, 4),
    ('Could be better', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 10, 5),
    ('Good product, but overpriced', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 10, 6),
    ('Excellent value for money', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 10, 7),
    ('Not satisfied with the quality', 2, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 10, 8),
    ('Great product, will buy again', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 11, 4),
    ('Decent quality, but not the best', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 11, 5),
    ('Very comfortable', 4, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 11, 6),
    ('Good product, but could be cheaper', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 11, 7),
    ('Excellent quality, very satisfied', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 11, 8),
    ('Very happy with this purchase', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 12, 4),
    ('Not worth the money', 2, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 12, 5),
    ('Good quality, but too expensive', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 12, 6),
    ('Satisfied with the product', 4, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 12, 7),
    ('Excellent product, highly recommend', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 12, 8),
    ('Great value for money', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 13, 4),
    ('Not as good as expected', 2, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 13, 5),
    ('Decent quality, but overpriced', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 13, 6),
    ('Very satisfied with this purchase', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 13, 7),
    ('Good product, but could be better', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 13, 8),
    ('Excellent quality, will buy again', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 14, 4),
    ('Not worth the price', 2, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 14, 5),
    ('Average quality', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 14, 6),
    ('Very satisfied with this product', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 14, 7),
    ('Would not recommend', 1, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 14, 8),
    ('Amazing product, exceeded expectations', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 15, 4),
    ('Good quality, but a bit expensive', 4, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 15, 5),
    ('Satisfied with the purchase', 4, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 15, 6),
    ('Not as described', 2, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 15, 7),
    ('Excellent quality, highly recommend', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 15, 8),
    ('Very happy with this product', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 16, 4),
    ('Could be better', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 16, 5),
    ('Good product, but overpriced', 3, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 16, 6),
    ('Excellent value for money', 5, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 16, 7),
    ('Not satisfied with the quality', 2, DATE '2024-11-01' + (INTERVAL '1 day' * FLOOR(RANDOM() * 30)), 16, 8);